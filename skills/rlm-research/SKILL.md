...
- User wants to describe a specific module (use `/rlm-describe`)
- User wants a design doc from conversation (use `/rlm-design`)
- User wants a quick file search (use grep or `/rlm-map`)
- User wants to extract decisions from past sessions (use `/rlm-distill`)
