...
to the **rlm-process** agent. You stay clean -- prepare the input,
...
Invoke the rlm-process agent. It has the rlm-core skill
...
Note: `--agent rlm-process` replaces manual `--model`,
