...
- User wants to check code against a specific design doc (use `/rlm-validate`)
- User wants to investigate a failure or bug (use `/rlm-diagnose`)
- User wants to understand how something works (use `/rlm-describe` or `/rlm-research`)
