...
- User wants to check design compliance (use `/validate`)
- User wants to understand how something works (use `/research` or `/create-description`)
...
- User wants to design a solution (use `/design`)
