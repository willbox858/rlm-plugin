---
name: rlm-implement-worker
description: "Shared methodology for implementation workers (orchestrator, worker, test-writer, verifier). Covers TDD protocol, verification workflow, iterative narrowing, convergence criteria, iteration tracking, git discipline, and project config loading. Used by all workers in the /rlm-implement pipeline."
---
